...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 习惯追踪工具", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "habit-tracker".lower() or "clock" in "habit-tracker".lower():
            self.setup_timer_ui(main)
        elif "random" in "habit-tracker".lower() or "dice" in "habit-tracker".lower() or "coin" in "habit-tracker".lower():
            self.setup_random_ui(main)
        elif "note" in "habit-tracker".lower() or "todo" in "habit-tracker".lower():
    ...
    def generate_random(self):
        if "dice" in "habit-tracker".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "habit-tracker".lower():
